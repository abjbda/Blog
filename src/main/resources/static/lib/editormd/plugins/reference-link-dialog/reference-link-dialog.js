		...
		exports.fn.referenceLinkDialog = function() {
            ...
            {      
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" +
                                        ...
                                        "<input category=\"text\" value=\"[" + ReLinkId + "]\" data-name />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlId + "</label>" +
                                        "<input category=\"text\" data-url-id />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.url + "</label>" +
                                        "<input category=\"text\" value=\"http://\" data-url />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlTitle + "</label>" +
                                        "<input category=\"text\" value=\"" + selection + "\" data-title />" +
                                        "<br/>" +
                                    "</div>";
