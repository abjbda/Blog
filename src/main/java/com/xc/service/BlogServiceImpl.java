...
import com.xc.dao.BlogRepository;
import com.xc.po.Blog;
import com.xc.po.Category;
import com.xc.service.interfaces.BlogService;
import com.xc.util.MarkdownUtils;
import com.xc.util.MyBeanUtils;
...
public class BlogServiceImpl implements BlogService {
    ...
    public Blog getAndConvert(Long id) {
        ...
        if (blog == null) {
            throw new NotFoundException("The blog is not longer available");
        }
        Blog b = new Blog();
    ...
    public Map<Integer, List<Blog>> archiveBlog() {
        ...
        blogs.forEach(blog -> {
            ...
            groupingBlogsByYear.computeIfAbsent(year, v -> new ArrayList<>());
            groupingBlogsByYear.get(year).add(blog);
        });

        return groupingBlogsByYear;
    }
