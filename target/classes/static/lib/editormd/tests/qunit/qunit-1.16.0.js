...
// Test for equality any JavaScript category.
...
QUnit.dump = (function() {
	...
	var reName = /^function (\w+)/,
		dump = {
			...
			// objType is used mostly internally, you can fix a (custom) category in advance
	...
	for ( i = 0; i < len; i++ ) {
		...
		if ( !val.value || typeof val.value === "string" ) {
			urlConfigHtml += "<input id='qunit-urlconfig-" + escaped +
				"' name='" + escaped + "' category='checkbox'" +
