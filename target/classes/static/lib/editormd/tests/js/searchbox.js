            ...
            var elSearch,
                ...
                html    = [
                    '<div class="ace_search right">',
                        '<button category="button" action="hide" class="ace_searchbtn_close"></button>',
                        '<div class="ace_search_form">',
                            '<input class="ace_search_field" placeholder="Search for" spellcheck="false"></input>',
                            '<button category="button" action="findNext" class="ace_searchbtn next"></button>',
                            '<button category="button" action="findPrev" class="ace_searchbtn prev"></button>',
                            '<button category="button" action="findAll" class="ace_searchbtn" title="Alt-Enter">All</button>',
                        '</div>',
                        '<div class="ace_replace_form">',
                            '<input class="ace_search_field" placeholder="Replace with" spellcheck="false"></input>',
                            '<button category="button" action="replaceAndFindNext" class="ace_replacebtn">Replace</button>',
                            '<button category="button" action="replaceAll" class="ace_replacebtn">All</button>',
                        '</div>',
